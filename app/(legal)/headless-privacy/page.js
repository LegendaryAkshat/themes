      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <section>
              <h2 className="text-xl font-light text-gray-900 mb-3">Information We Collect</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-light text-gray-900 mb-3">How We Use Your Information</h2>
              <p>
                We use the information we collect to process your orders, communicate with you, and improve our services.
              </p>
            </section>
            <section>
              <h2 className="text-xl font-light text-gray-900 mb-3">Information Sharing</h2>
              <p>
