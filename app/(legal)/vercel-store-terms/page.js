...
const pageConfig = {
  ...
  sections: [
    ...
    {
      title: "2. Use License",
      content: "Permission is granted to temporarily download one copy of the materials on Acme Store's website for personal, non-commercial transitory viewing only."
    },
    {
      title: "3. Disclaimer",
      content: "The materials on Acme Store's website are provided on an 'as is' basis. Acme Store makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties."
    },
    {
      title: "4. Limitations",
      content: "In no event shall Acme Store or its suppliers be liable for any damages arising out of the use or inability to use the materials on Acme Store's website."
    }
  ],
