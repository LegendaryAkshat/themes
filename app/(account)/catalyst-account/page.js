...
const pageConfig = {
  ...
  navigation: [
    { label: "Account Details", icon: "User", link: "/catalyst-account", active: true },
    { label: "Orders", icon: "Package", link: "/catalyst-account-orders", active: false },
    { label: "Addresses", icon: "MapPin", link: "/catalyst-account-addresses", active: false },
    { label: "Payment Methods", icon: "CreditCard", link: "/catalyst-account-profile", active: false }
  ],
