...
const pageConfig = {
  ...
  order: {
    ...
    total: "$284.99",
    items: [
      { name: "ZZ Plant", price: "$80.00", quantity: 1, image: "🌿", link: "/catalyst-product-detail" },
      { name: "Snake Plant", price: "$109.99", quantity: 2, image: "🌵", link: "/catalyst-product-detail" }
    ],
    shipping: {
      address: "123 Plant St, Planttown, USA",
  ...
  return (
    <main className={`min-h-screen w-full ${colors.background}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className={`${colors.card} rounded-lg ${colors.borders.default} p-6 mb-6`}>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className={`${colors.card} rounded-lg ${colors.borders.default} p-6`}>
