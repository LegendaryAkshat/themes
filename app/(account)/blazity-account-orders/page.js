...
const pageConfig = {
  ...
  // Navigation Menu
  navigation: [
    { label: "Account Details", icon: "Package", link: "/blazity-account", active: false },
    { label: "Orders", icon: "Package", link: "/blazity-account-orders", active: true }
  ],
  
  // Orders (Edit orders here!)
  orders: [
    { id: "12345", date: "Jan 10, 2025", total: "$428.76", status: "Delivered", items: 3, link: "/blazity-account-order-detail" },
    { id: "12344", date: "Dec 28, 2024", total: "$259.99", status: "Shipped", items: 2, link: "/blazity-account-order-detail" },
    { id: "12343", date: "Dec 15, 2024", total: "$149.00", status: "Delivered", items: 1, link: "/blazity-account-order-detail" }
  ]
};
