      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-bold mb-8">
            <span className="block bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 via-pink-400 to-purple-400">
              Principles
            </span>
            <span className="block text-white">That Guide Us</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            The foundational beliefs that shape every aspect of how we build, grow, and create value.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {principles.map((principle, index) => {
            ...
            return (
              ...
              >
                <div className="relative bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10 hover:border-white/30 transition-all overflow-hidden">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="relative bg-gradient-to-r from-yellow-500/20 via-pink-500/20 to-purple-500/20 backdrop-blur-md rounded-3xl p-12 md:p-16 border border-white/20 overflow-hidden"
        >
          {/* Animated Background */}
          ...
          <div className="relative z-10 text-center">
            ...
            >
              "These principles aren't just words on a wall—they're the foundation of every decision, 
              every product, and every relationship we build. They remind us why we started and guide us 
              toward where we're going."
            </motion.p>
            <motion.div
              initial={{ opacity: 0 }}
