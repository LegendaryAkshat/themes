    ...
    <main className="min-h-screen w-full bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Shop - Left Sidebar</h1>
          <p className="text-gray-600">Browse our collection with filters on the left</p>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {["Clothing", "Accessories", "Shoes", "Bags", "Watches"].map((cat) => (
