...
const pageConfig = {
  ...
  page: {
    title: "Product List",
    description: "Detailed view of our outdoor gear"
  },
  
  // Products (Edit products here!)
  products: [
    { id: 1, name: "Inflatable Kayak", price: "$983.00", rating: 4.8, description: "Premium inflatable kayak for whitewater adventures", image: "kayak", link: "/blazity-product-detail" },
    { id: 2, name: "Camping Tent", price: "$299.00", rating: 4.9, description: "Weather-resistant tent for 4 people", image: "tent", link: "/blazity-product-detail" },
    { id: 3, name: "Hiking Backpack", price: "$189.00", rating: 4.7, description: "Durable backpack with multiple compartments", image: "backpack", link: "/blazity-product-detail" }
  ],
