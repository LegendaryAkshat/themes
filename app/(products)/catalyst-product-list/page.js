...
export default function Page() {
  ...
  const products = [
    { id: 1, name: "ZZ Plant", price: "$80.00", rating: 4.8, description: "Low-maintenance houseplant perfect for beginners", image: "plant1" },
    { id: 2, name: "Monstera", price: "$95.00", rating: 4.9, description: "Tropical plant with distinctive split leaves", image: "plant2" },
    { id: 3, name: "Snake Plant", price: "$65.00", rating: 4.7, description: "Air-purifying plant that thrives in low light", image: "plant3" }
  ];
    ...
    <main className="min-h-screen w-full bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Detailed view of our plants</p>
        </div>
