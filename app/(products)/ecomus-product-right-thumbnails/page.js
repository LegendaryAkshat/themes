    ...
    <main className={`min-h-screen w-full ${colors.background}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Product Images - Right Thumbnails */}
          <div className="flex gap-4">
            {/* Main Image */}
            <div className={`flex-1 aspect-square ${colors.gradients.image} rounded-2xl overflow-hidden`}>
            ...
            <div className="flex flex-col gap-2">
              {thumbnails.map((i) => (
                <button
                  ...
                  className={`${images.thumbnailSize} ${colors.gradients.image} rounded-lg border-2 ${
