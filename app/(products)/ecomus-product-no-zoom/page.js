...
const pageConfig = {
  ...
  product: {
    ...
    rating: 4.8,
    reviews: 128,
    description: "Standard product view without zoom functionality. Premium quality product with exceptional features."
  },
    ...
    <main className={`min-h-screen w-full ${colors.background}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className={`aspect-square ${colors.gradients.image} rounded-2xl overflow-hidden`}>
