...
const pageConfig = {
  ...
  brand: {
    ...
    ordersLink: "/vercel-store-account-orders",
    logo: {
      background: "bg-white",
      icon: "bg-black"
    }
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        >
          <div className="flex justify-center">
            <div className={`w-20 h-20 ${colors.success.icon} rounded-full flex items-center justify-center`}>
          ...
          <div className="pt-6 space-y-4">
            <p className={`text-sm ${colors.text.light}`}>{page.orderNumber}</p>
            <p className={`text-sm ${colors.text.light}`}>{page.emailMessage}</p>
