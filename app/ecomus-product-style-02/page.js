            ...
            >
              <div className="relative aspect-square bg-gradient-to-br from-blue-50 to-purple-50 overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-32 h-32 bg-gradient-to-br from-blue-200 to-purple-200 rounded-xl"></div>
                </div>
                <div className="absolute top-4 right-4">
                  <motion.button
                    ...
                    className={`p-2 rounded-full ${
                      wishlist.has(product.id) ? "bg-red-500 text-white" : "bg-white text-gray-700 shadow-md"
                    }`}
                  >
              ...
              <div className="p-5">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2 rounded-lg font-semibold flex items-center justify-center gap-2"
                >
