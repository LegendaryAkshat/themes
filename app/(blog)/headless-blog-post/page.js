  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <div>
            <Link href="/blog" className="text-gray-600 hover:text-gray-900 transition-colors mb-4 block">
              ← Back to Blog
            </Link>
            <p className="text-sm text-gray-500 mb-4">March 20, 2024</p>
            <h1 className="text-4xl font-light text-gray-900 mb-6">Spring Collection Preview</h1>
          </div>
